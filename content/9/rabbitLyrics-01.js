(async () => {
    ...
    // -----------------------------------------------------------------------
    // 【修正部分】 loadScriptAndGetExport 函数现在定义在 IIFE 内部，避免全局冲突
    // -----------------------------------------------------------------------
    ...
    // -----------------------------------------------------------------------
    // 【注意】您原来的代码中将 script 添加到 elem，这里我修正为 document.head。
    // 如果您坚持将 script 添加到 article.popover-hint，请使用下面的代码替换上面的 targetElementForScript：
